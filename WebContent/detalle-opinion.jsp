...
<body>
	<div id="canvas" style="margin: 0px; left: auto; height: 100px;  background-color: rgb(255, 255, 255);" > 
	 ...
	 <div id="content"> 
	   <div style="margin: 0px auto; width: 1364px; height: 750px; position: relative; background-color: rgb(239, 239, 239); background-image: url(img/salons.jpg)">  
      ...
      <div style="background-color: rgba(255, 255, 255, 0); border-color: rgb(51, 51, 51); opacity: 1; border-style: none; background-image: none; box-shadow: rgba(0, 0, 0, 0.498039) 0px 0px 0px 0px;">
         <img src="./img/salons.jpg" alt="" style="width: 1363px;  display: inline;">
      </div>-->

      <div style="left: 0px; top: 0px; width: 1366px; height: auto; position: absolute; z-index: 104;">
	       <div style=" top:50px; width: 700px; height: auto; position: relative; border-color: rgb(51, 51, 51); opacity: 0.9; background-image: none; background-color: #EFEFEF; font-family: Calibri, sans-serif; margin-left: auto; margin-right: auto; padding: 10px; box-shadow: 3px 3px 5px gray; border-radius: 10px; padding: 10px;">

             <!--<label for="title" >Scissors</label> <br> -->
             
             <span style="font-family: Calibri; color:#e85858; font-size: 20px;">Buen Sitio para corte de cabello</span> <span style="color:#000000; font-size: 12px;">&nbsp;por: <b>MarinaLima &nbsp;08/03/2015 17:00</b></span><br> <br>
             
             El día de ayer me atendí con mi amiga en este negocio y he quedado muy contenta, he encontrado gente muy amable en la recepción y el tiempo de espera lo pasé comiendo chocolates y revisando una buena revista, se esmeran bastante en ese aspecto.  Otra cosa que destaco es que al final de la sesión me entregaron muestras de los productos que usan y eso me pareció genial pues en otro momento puedo pedir que los usen para mi.<br>
             Calificaci&oacute;n:&nbsp;<!-- Poner tantas estrellas como tenga el negocio -->
             <span style="font-size: 36px; color: #e8CC58;  text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -2px black;">&#x2605;&#x2605;&#x2605;
             </span>
             </span>
             <br>
             Servicio Principal Contratado: 
             ...
             <br>
             <br>
             Otros Servicios contratados:<br>
             <table>
               <tr>
                 <td><input type="checkbox" value="peluquería" checked>Peluquería</td> 
                 <td><input type="checkbox" value="spa" checked>Spa  </td> 
                 <td> <input type="checkbox" value="Manicure y/o Pedicure" checked>Manicure y/o Pedicure</td> 
               </tr>
               <tr>
                 <td><input type="checkbox" value="Sauna">Sauna </td> 
                 <td><input type="checkbox" value="masajes">Masajes </td> 
                 <td><input type="checkbox" value="tratamientos">Tratamiento de la piel </td> 
               </tr>
               <tr>
                 <td><input type="checkbox" value="cabello">Tratamiento de cabello </td>
                 <td><input type="checkbox" value="depilación">Depilación </td>
               </tr>
             </table>
             <br>
             <input type="submit" id="publish" value="Regresar">
	       </div>
	     </div>
