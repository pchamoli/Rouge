...
public class UsuarioBean {
	...
	public String getDescrip_servicio() {
		return descrip_servicio;
	}

	public void setDescrip_servicio(String descrip_servicio) {
		this.descrip_servicio = descrip_servicio;
	}
	...
	public UsuarioBean(int id, String nombre, String fechanac, String email,
			...
			int tipo_usuario, int numero_documento, int tipo_documento,
			int ubigeo, int servicio, String sexo) {
		super();
		this.id = id;
		this.nombre = nombre;
		this.fechanac = fechanac;
	...
	public UsuarioBean(int id, String nombre, String fechanac, String email,
			...
			String usuario_creacion, String usuario_actualizacion,
			String codigo_usuario, String estado, String contrasena,
			int tipo_usuario, String sexo, String nombre_tipo_usuario,
			String nombre_tipo_documento, String descrip_servicio,
			String distrito) {
		super();
		this.id = id;
		this.nombre = nombre;
