...
public class PruebaControlador extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		NegocioBean nb = new NegocioBean();
		...
		*/
		...
		//res = lcs1.buscarLocalServicio("1", 0, 10);
		
		/*
		lc2.setId(1);
		lc2.setNombre("Jhon");
		lc2.setFechanac("2015-12-11");
		lc2.setFecha_creacion("2015-12-11");
		lc2.setFecha_actualizacion("2015-12-11");
		lc2.setUsuario_creacion("jh");
		lc2.setUsuario_actualizacion("jhp");
		lc2.setCodigo_usuario("lk1");
		//lc2.setEstado("e");
		lc2.setContrasena("123");
		lc2.setUbigeo(10000);
		//lc2.setTipo_usuario(1);
		
		nb.setId_negocio(2);
		nb.setNombre("Stylos");
		nb.setDireccion("Av Los tusilagos");
		nb.setTelefono("7891211");
		nb.setEmail("stylos@hotmail.com");
		nb.setCod_ubigeo(10000);
		nb.setId_foto(1);
		nb.setC_usuario_creacion("jh");
		nb.setC_usuario_actualizacion("jhp");
		nb.setD_fecha_creacion("2015-12-11");
		nb.setD_fecha_actualizacion("2015-12-11");
		nb.setCalificacionfinal(9.5);
		
		res = lcs1.registrarNegocio(lc2,nb);*/
		
		OpinionService ops = new OpinionService();
		res = ops.obtenerDetalleOpinion("lk", 1);
		//res = ops.listarOpinionesLocal("jh2", 1,0, 10);
		//res = ops.listarOpinionesUsuario("jh2", 0, 10);
		...
		if (res != null) {
			...
			System.out.println("C�digo Usuario: " + ub.getCodigo_usuario());*/
