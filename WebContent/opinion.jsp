...
<body>
	<div id="canvas" style="margin: 0px; left: auto; height: 100px;  background-color: rgb(255, 255, 255);" > 
	 ...
	 <div id="content"> 
      ...
      <div id="asset-1453162245552" style="left: 0px; top: 0px; width: 1366px; height: auto; position: absolute; z-index: 104;">
	       <div style=" top:50px; width: 600px; height: auto; position: relative; border-color: rgb(51, 51, 51); opacity: 0.9; background-image: none; background-color: #EFEFEF; font-family: Calibri, sans-serif; margin-left: auto; margin-right: auto; padding: 10px; box-shadow: 3px 3px 5px gray; border-radius: 10px;">
	         <!-- Colocar aqui iframes o cuadros de rouge -->

             <div id="Titulo" style="position: relative; opacity: 1;" spellcheck="false">
               <h2 style="text-align: center;">
                 <span style="">INGRESA TU OPINION</span>
               </h2>
             </div>

           <form id="review" style="margin:auto;width:90%;"> 
             <label for="title" >Centro:</label> <br> 
             <input id="resume" required="" type="text" size="50"><br>
             <label for="title" >Título de Opinión:</label> <br> 
             <input id="resume" required="" type="text" size="50"><br>
             Un resumen de tu opinión. Por ejemplo:"Me encantó" o "Un servicio de primera"<br><br>
             <label for="title" >Calificación:</label><br> 
             <div class="stars">
             ...
             <textarea rows="5" cols="50" form="review" required="" data-minlen="100&quot;" maxlength="250"></textarea> <br> 
             (Min.100 caracteres) <br><br>
             Servicio Contratado:(*)
             <!--Colocar los servicios que da el local-->
             <select  value="0">
               <option value="0">(...)</option>             
               <option value="1">Peluquería</option>
               <option value="2">Spa</option>
               <option value="3">Manicure y/o Pedicure</option>
               <option value="4">Sauna</option>
               <option value="5">Masajes</option>
               <option value="6">Tratamiento de la piel</option>               
               <option value="7">Tratamiento de cabello</option>   
             </select>
             ...
             <table>
               <tr>
                 <td><input type="checkbox" value="peluquería">Peluquería</td> 
                 <td><input type="checkbox" value="spa">Spa  </td> 
                 <td> <input type="checkbox" value="Manicure y/o Pedicure">Manicure y/o Pedicure</td> 
               </tr>
               <tr>
             ...
             <br>
             <input type="submit" id="publish" value="Ingresar Opinión">
           </form>
	       </div>
	     </div>
